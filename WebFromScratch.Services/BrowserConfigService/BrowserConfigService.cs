...
namespace WebFromScratch.Services
{
    public class BrowserConfigService : IBrowserConfigService
    {
        ...
        public string GetBrowserConfigXml()
        {
            ...
            string square70x70logoUrl = _urlHelper.Content("~/img/icons/ms/mstile-70x70.png");
            // The URL to the 150x150 medium tile image.
            string square150x150logoUrl = _urlHelper.Content("~/img/icons/ms/mstile-150x150.png");
            // The URL to the 310x310 large tile image.
            string square310x310logoUrl = _urlHelper.Content("~/img/icons/ms/mstile-310x310.png");
            // The URL to the 310x150 wide tile image.
            string wide310x150logoUrl = _urlHelper.Content("~/img/icons/ms/mstile-310x150.png");
        ...
        //        _urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetFeed),
        //        feedEntry);
        //}
